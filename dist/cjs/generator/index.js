...
const generateOpenApiDocument = (appRouter, opts) => {
    ...
    return (0, zod_openapi_1.createDocument)({
        openapi: (_b = opts.openApiVersion) !== null && _b !== void 0 ? _b : '3.1.0',
        info: {
            title: opts.title,
        ...
        paths: (0, paths_1.mergePaths)((0, paths_1.getOpenApiPathsObject)(appRouter, Object.keys(securitySchemes), opts.filter), opts.paths),
        components: Object.assign({ securitySchemes }, (opts.defs && { schemas: opts.defs })),
