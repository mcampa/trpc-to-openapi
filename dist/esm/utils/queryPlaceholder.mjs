import { ZodObject, ZodOptional, ZodNullable, ZodDefault, ZodArray, ZodUnion, ZodEffects, ZodLiteral, ZodEnum, ZodNativeEnum, ZodRecord } from 'zod';
export function queryPlaceholder(schema) {
    ...
    if (baseSchema instanceof ZodOptional ||
