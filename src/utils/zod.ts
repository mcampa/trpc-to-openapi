...
export const instanceofZodTypeOptional = (
  type: $ZodType,
): type is z.ZodOptional<$ZodTypes> => {
...
export const unwrapZodType = (type: $ZodType, unwrapPreprocess: boolean): ZodType => {
  ...
  if (instanceofZodTypeKind(type, 'pipe') && unwrapPreprocess) {
    ...
    // if ((type as z.ZodTransform<$ZodTypes, unknown>)._def. === 'refinement') {
    //   return unwrapZodType((type as z.ZodTransform<$ZodTypes, unknown>)._def.schema, unwrapPreprocess);
    // }
    // if ((type as z.ZodTransform<$ZodTypes, unknown>)._def.effect.type === 'transform') {
...
export const instanceofZodTypeLikeString = (_type: $ZodType): boolean/* : _type is ZodTypeLikeString  */=> {
  ...
  //   if ((type as z.ZodTransform<$ZodTypes, unknown>)._def.effect.type === 'preprocess') {
  //     return true;
  //   }
  // }
